...
$PVCSPath: L:/src/asw/MSM5100/CP_REL_A/vcs/md5c.c_v   1.2   02 Oct 2002 22:52:32   louiel  $
$Header: //depot/asic/msmshared/services/common/md5c.c#1 $ $DateTime: 2006/05/04 09:20:44 $ $Author: ckrishna $


when       who     what, where, why
--------   ---    ----------------------------------------------------------
05/03/06   ck     Cleaned up featurizations
...
08/15/01   ss     Added FEATURE_DS_MOBILE_IP to include the file for CHAP or
                  MOBILE_IP.
03/27/00   ram    Included comdef.h to avoid compiler warning when
                  FEATURE_DS_CHAP was turned off.
        ...
        )
{
    ...
    context->state[0] = (uint32_t)0x67452301;
    context->state[1] = (uint32_t)0xefcdab89;
    context->state[2] = (uint32_t)0x98badcfe;
    context->state[3] = (uint32_t)0x10325476;
}
